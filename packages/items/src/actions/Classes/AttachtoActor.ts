        ...
        super({
            ...
            inputs: {
			    ...
			    "variable": [
			        ...
			        "(ExpectedType=class'SeqVar_Object',LinkedVariables=none,LinkDesc=\"Attachment\",LinkVar=None,PropertyName=None,bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)"
			    ]
			}
        })
    }
