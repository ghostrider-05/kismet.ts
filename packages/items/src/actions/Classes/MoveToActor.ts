...
export class MoveToActor extends SequenceAction {
        ...
        super({
            ...
            inputs: {
			    ...
			    "variable": [
			        ...
			        "(ExpectedType=class'SeqVar_Object',LinkedVariables=none,LinkDesc=\"Destination\",LinkVar=None,PropertyName=Destination,bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)",
			        "(ExpectedType=class'SeqVar_Object',LinkedVariables=none,LinkDesc=\"Look At\",LinkVar=None,PropertyName=LookAt,bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0)"
			    ]
			}
        })
    }
    static Variables = {
		...
		bPickClosest:'bPickClosest',
		Destination:'Destination',
		MovementSpeedModifier:'MovementSpeedModifier',
		LookAt:'LookAt',
		LastDestinationChoice:'LastDestinationChoice'
    }
}