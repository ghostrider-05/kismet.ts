...
export class IsTargetInPlayerCameraView extends SequenceAction {
        ...
        super({
            ...
            inputs: {
			    ...
			    "output": [
			        ...
			        "(Links=none,LinkDesc=\"Target Is In View\",bHasImpulse=false,bDisabled=false,bDisabledPIE=false,LinkedOp=none,ActivateDelay=0.0,DrawY=0,bHidden=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0,PIEActivationTime=0.0,bIsActivated=false)"
			    ],
			    "variable": [
