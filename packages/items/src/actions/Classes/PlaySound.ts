...
export class PlaySound extends SequenceAction {
        ...
        super({
            ...
            inputs: {
			    ...
			    "output": [
			        ...
			        "(Links=none,LinkDesc=\"Stopped\",bHasImpulse=false,bDisabled=false,bDisabledPIE=false,LinkedOp=none,ActivateDelay=0.0,DrawY=0,bHidden=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0,PIEActivationTime=0.0,bIsActivated=false)",
			        "(Links=none,LinkDesc=\"BeforeEnd\",bHasImpulse=false,bDisabled=false,bDisabledPIE=false,LinkedOp=none,ActivateDelay=0.0,DrawY=0,bHidden=false,bMoving=false,bClampedMax=false,bClampedMin=false,OverrideDelta=0,PIEActivationTime=0.0,bIsActivated=false)"
			    ],
			    "variable": []
			}
        })
    ...
    static Variables = {
		...
		bDelayReached:'bDelayReached',
		bSuppressSubtitles:'bSuppressSubtitles',
		bStopped:'bStopped',
